...
var pop_up_note_mode = true;
        ...
        function switchsound() {
            ...
            if (au.paused) {
                au.play();
                ai.src = "img3/music_note_big.png";
                pop_up_note_mode = true;
                popup_note();
                $$("music_txt").innerHTML = "打开";
				document.getElementById("sound_image").className= 'rot_img';
				...
				document.getElementById("sound_image").className= '';
                $$("music_txt").style.visibility = "visible";
                setTimeout(function () { $$("music_txt").style.visibility = "hidden" }, 2500);
            }
        }
        ...
        function popup_note() {
            ...
            note.style.cssText = "visibility:visible;position:absolute;background-image:url('img3/music_note_small.png');width:15px;height:25px";
        ...
        function playbksound() {
            ...
            sound_div.style.cssText = "position:fixed;right:20px;top:30px;z-index:5000;visibility:visible;";
            sound_div.onclick = switchsound;
            if (document.body.offsetWidth > 400) {
                bg_htm = "<img id='sound_image' src='img3/music_note_big.png' class='rot_img'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
            }
            else {
                bg_htm = "<img id='sound_image' width='30px' src='img3/music_note_big.png' class='rot_img'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:7px;top:-80px'></div>";
            }
            txt_htm = "<div id='music_txt' style='color:white;position:absolute;left:-40px;top:8px;width:60px'></div>"
